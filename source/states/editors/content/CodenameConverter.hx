...
{
    // Convert Codename Engine chart to Psych Engine
    public static function convertCodenameToPsych(jsonPath:String, ?metaPath:String):SwagSong
    {
        ...
        try {
            ...
            if (metaPath != null) trace('Meta file: $metaPath');
            
            // 1. Use MoonChart to load the Codename Engine file
            ...
            trace('  Song title: ${codenameChart.meta.displayName}');
            trace('  Note types: ${codenameChart.data.noteTypes.length}');
    ...
    // Convert Psych Engine to Codename Engine
    public static function convertPsychToCodename(psychSong:SwagSong, outputPath:String):Bool
    {
        try {
            ...
            // 2. Use MoonChart to create Codename Engine chart
            ...
            // 5. Save metadata file if it exists
            if (codenameOutput.meta != null) {
                var metaPath = outputPath.replace('.json', '-meta.json');
