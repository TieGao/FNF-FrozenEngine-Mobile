...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:PsychOption = new PsychOption('Low Quality', //Name
		...
		var option:PsychOption = new PsychOption('Shaders', //Name
			"If unchecked, disables shaders.\nIt's used for some visual effects, and also CPU intensive for weaker.", //Description
			'shaders',
			BOOL);
		addOption(option);

		var option:PsychOption = new PsychOption('GPU Caching', //Name
